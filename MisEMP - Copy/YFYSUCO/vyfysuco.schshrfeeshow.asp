...
SQL=" select isnull(D.EXRT,1) exrt , a.autoid as Mautoid, a.sgno as Msgno,  "&_
	...
	"b.autoid,b.sgno,b.sgym,b.cfgroup,b.empid,b.cfdw,b.driverID,b.whsno,b.YM, isnull(b.SUKM,0) sukm ,b.memo,b.DM,b.aid  from  "&_
...
END IF
SQL=SQL&"ORDER BY B.EMPID,A.SGYM, A.SGNO, B.CFGROUP"
'RESPONSE.WRITE SQL
'response.end
