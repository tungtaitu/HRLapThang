...
<table width=500  cellspacing="1" cellpadding="1" border=0 class="txt" bgcolor="#e4e4e4">
	<TR bgcolor="#ffffff">
		<td width=60 align="right" >查詢年月<br>Tìm ngày<br>YYYYMM</td>
		<td COLSPAN=3>
	...
	<tr bgcolor="#ffffff">
		<td width=60 align="right">員工編號<br>Mã số nhân viên</td>
		...
		<td  align="right">到職日期<br>Ngày nhập xưởng</td>
		<td  valign="top"><%=indat%>
	...
	<tr bgcolor="#ffffff" >
		...
		<td  align="right">離職日期<BR>Ngày thôi việc</td>
...
<TABLE BGCOLOR="#CCCCCC" BORDER=0 border="1" cellspacing="1"  class=txt8 >
	<TR BGCOLOR=#FFFFCC>
		...
		<TD ROWSPAN=2 ALIGN=CENTER>工時<br>Giờ làm</TD>
		<TD ROWSPAN=2 ALIGN=CENTER>曠職<br>Vắng mặt</TD>
		<TD ROWSPAN=2 ALIGN=CENTER>忘遲早<br>Quên<br> bấm thẻ</TD>
		<TD COLSPAN=4 ALIGN=CENTER>加班(單位：小時)<br>Tăng ca (Đơn vị :giờ)</TD>
		<TD COLSPAN=9 ALIGN=CENTER>休假(單位：小時)<br>Ngày phép(Đơn vị :giờ)</TD>
	</TR>
	<TR BGCOLOR=#FFFFCC>
		...
		<TD ALIGN=CENTER>事假(A)<br>Việc riêng</TD>
		<TD ALIGN=CENTER>病假(B)<br>Bênh</TD>
		<TD ALIGN=CENTER>年假(E)<br>Năm</TD>
		<TD ALIGN=CENTER>婚假(C)<br>Kết hôn</TD>
		<TD ALIGN=CENTER>喪假(D)<br>Tang</TD>
		<TD ALIGN=CENTER>產假(F)<br>Thai sản</TD>
		<TD ALIGN=CENTER>公假(G)<br>Công</TD>
		<TD ALIGN=CENTER>工傷(H)<br>Thương </TD>
		<TD ALIGN=CENTER>返鄉(I)<br>Về nước</TD>
	</TR>
	<%
	sum_TOTHOUR = 0
	sum_KZhour = 0
	...
	<%next%>
	<tr BGCOLOR="Lavender" >
		<td align=right colspan=3 HEIGHT=22>總計 Tổng kết</td>
...
<tr>
	...
	<input type=BUTTON name=send value="關閉此視窗(CLOSE) Đóng"  class=button ONCLICK="vbscript:window.close()">　　
	</td>
