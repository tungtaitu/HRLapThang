<%
const self ="salarycp05.getrpt.asp"
%>
<%

if session("rights")<="1" then 
	reportname = "EMPDjiabanN.rpt" 
else	
	reportname = "EMPDjiaban.rpt" 
end if 	
...
Session("oRpt").ParameterFields(6).AddCurrentValue(Cstr(code05))
Session("oRpt").ParameterFields(7).AddCurrentValue(Cstr(code06)) 
Session("oRpt").ParameterFields(8).AddCurrentValue(Cstr(outemp))
Session("oRpt").ParameterFields(9).AddCurrentValue(Cstr(acc))
