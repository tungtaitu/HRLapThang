		...
		<tr>
			<td align="center">
				<table id="myTableForm" width="40%">
					...
					<TR> 
						<TD align=right nowrap style="width:10%">計算年月</TD>
						<td style="width:80%"><input type="text" style="width:100px" name=khym value="<%=khym%>" maxlength=6 ></td>	
					</tr> 
					<TR height=30 > 
					...
					<TR>
						...
						<td >
							<input type="text" style="width:40%" name=empid  size=6 maxlength=5 onchange=strchg(1)>
							<input type="text" style="width:55%" name=empname  readonly  size=15 maxlength=5 >
						</td>
					</TR> 
					<tr>
