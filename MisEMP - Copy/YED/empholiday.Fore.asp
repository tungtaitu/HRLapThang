...
<INPUT TYPE=HIDDEN NAME="cfs" VALUE="<%=cfs%>">
...
<TABLE WIDTH=460 BORDER=0>   
	<TR height=25 >
		<TD nowrap align=right WIDTH=150>員工編號：</TD>
		<TD COLSPAN=3 >
			<INPUT NAME=EMPID SIZE=10 CLASS=INPUTBOX value="<%=empid%>" readonly > 
			<INPUT NAME=EMPNAMECN SIZE=15  CLASS=READONLY READONLY value="<%=empnam_cn%>" >
		</TD> 
	</TR>	
	<TR>
		<TD></TD>
		<TD COLSPAN=3 ><INPUT NAME=EMPNAMEVN SIZE=30  CLASS=READONLY READONLY value="<%=empnam_vn%>"> </TD>
	</TR>	
	<TR><TD HEIGHT=20></TD></TR>
	<TR>
		<TD align=right >請假類別：</TD>
		<TD COLSPAN=3>
			<SELECT NAME=HOLIDAY_TYPE CLASS=TXT11> 
				<OPTION value=E>(E) 年假</OPTION>
				<OPTION value=G>(G) 公假</OPTION>
				<OPTION value=A>(A) 事假</OPTION>
				<OPTION value=B>(B) 病假</OPTION>				
				<OPTION value=H>(H) 工傷</OPTION>
				<OPTION value=C>(C) 婚假</OPTION>
				<OPTION value=D>(D) 喪假</OPTION>
				<OPTION value=F>(F) 產假</OPTION>
			</SELECT>
		</TD>
	</TR>
	<TR>
		<TD align=right   WIDTH=150>請假日期(起)：</TD>
		<TD WIDTH=80 ><INPUT NAME=HHDAT1 CLASS=INPUTBOX SIZE=12 MAXLENGTH=10   onblur="date_change(1)"></TD>
		<TD align=right WIDTH=60>時間：</TD>
		<TD WIDTH=170><INPUT NAME=HHTIM1 CLASS=INPUTBOX SIZE=8 MAXLENGTH=5 ONBLUR="TIMEUP_chg()"></TD>
	</TR>	
	<TR>
		<TD align=right WIDTH=150 >請假日期(訖)：</TD>
		<TD WIDTH=80 ><INPUT NAME=HHDAT2 CLASS=INPUTBOX SIZE=12 MAXLENGTH=10   onblur="date_change(2)" ></TD>
		<TD WIDTH=60 align=right >時間：</TD>
		<TD WIDTH=170><INPUT NAME=HHTIM2 CLASS=INPUTBOX SIZE=8 MAXLENGTH=5 ONBLUR="TIMEDOWN_chg()" ></TD>
	</TR> 
	<TR>
		<TD align=right VALIGN=TOP>時數：</TD>
		<TD COLSPAN=3><INPUT NAME=toth CLASS=INPUTBOX SIZE=5 MAXLENGTH=2  STYLE="TEXT-ALIGN:CENTER" >小時
		<!--INPUT NAME=totD CLASS=READONLY READONLY  SIZE=5 MAXLENGTH=2  STYLE="TEXT-ALIGN:CENTER" -->
		</TD>
	</TR>	
	<TR>
		<TD align=right VALIGN=TOP>事由：</TD>
		<TD COLSPAN=3><TEXTAREA rows=5 cols=30 name=memo></TEXTAREA></TD>
	</TR>
</table>	
...
<tr>
	...
	<td align=CENTER>
		...
		<input type="button" name="send" value="(M)Back Main" class=button onclick="history.back">	
