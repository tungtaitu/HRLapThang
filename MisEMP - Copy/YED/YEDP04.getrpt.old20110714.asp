<%
reportname = "YEDP04.rpt"

code01=request("country")
code02=request("whsno")
code03=replace(request("indat1"),"/","")
code04=replace(request("indat2"),"/","")
code05=request("groupid")
code06=replace(trim(request("zuno"))," ","") 
