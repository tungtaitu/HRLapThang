...
<form name="<%=self%>" method="post" >
	...
	<table width="100%" border=0 >
		<tr>
			<td align="center">
				<%
				'response.write Session("NETUSERTYPE")
				'response.write Session("NETUSER")
				if Session("NETUSERTYPE")="AAA" or Session("NETUSER")="L0910" or Session("NETUSER")="L0197" or Session("NETUSER")="EF004" then
				%>			
