	...
	<tr>
		<td align="center">
			<table id="myTableForm" width="50%"> 
				...
				<tr>
					<TD nowrap align=right>計薪年月<br>Tien luong(Yyyymm)</TD>
				...
				<TR  > 
					<td colspan=4 align=center>				
						...
						<input type="hidden" size=1 name=job   value="A">
						<input type="hidden" name=empid1  size=15 maxlength=5 onchange=strchg(1)>
					</td>
				</TR>				
				<tr >
