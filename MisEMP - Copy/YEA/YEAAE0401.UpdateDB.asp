...
<%
const self		="YEAAE0401.UPDATEDB.ASP"
const action	="YEAAE0401.FORE.ASP"
...
response.redirect "YEAAE0401.fore.asp?SearchKey=" & left(SearchKey,1) &"&GROUP_ID=" & trim(GROUP_ID)
response.end
%>
<html>
<head>
