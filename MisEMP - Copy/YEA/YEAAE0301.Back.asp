...
response.write "4=" & server.URLEncode(request("program_name")) &"<BR>"
...
<%			set rs=nothing 
	   ...
	   Case "datachg"
			...
			tmpRec(CurrentPage,index + 1,2) = server.URLEncode(program_name)
...
%> 
<form name=form1 >
	<input name=t1 value="<%=server.urlencode(program_name)%>">
