		...
		<tr>
			<td align="center">
				<table id="myTableForm" width="50%"> 
					...
					<TR>
						<TD width="10%" nowrap align=right height=30 >到職年月<br><font class=txt8>Thong ke Thang Nam</font></TD>
						<TD width="40%" >
					...
					<TR>
						...
						<td width="10%"  nowrap align=right >員工編號<br><font class=txt8>So The</font></td>
						<td  width="40%" >
							<input name=empid1  size=15 maxlength=5 onchange=strchg(1)>
