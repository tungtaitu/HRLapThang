...
reportname="empcard_wb.rpt"
'response.write  code01 &"<BR>"
'response.write  loai &"<BR>"
...
Session("oRpt").ParameterFields(2).AddCurrentValue(Cstr(loai))
Session("oRpt").ParameterFields(3).AddCurrentValue(Cstr(code05))
Session("oRpt").ParameterFields(4).AddCurrentValue(Cstr(code06))
