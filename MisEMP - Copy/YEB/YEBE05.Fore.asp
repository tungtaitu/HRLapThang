...
<table width="460" border="0" cellspacing="0" cellpadding="0" class=txt99>
	<tr>
		<TD><a href="<%=self%>.Fore.asp">查詢(K.Tra)</a></TD>
		<TD><a href="<%=self%>.New.asp">新增(THÊM MỚI)</a></TD>
		<TD><a href="<%=self%>.edit.asp">資料刪修(XOÁ ĐI/THAY ĐỔI)</a></TD>
	</tr>
</table>
<hr size=0	style='border: 1px dotted #999999;' align=left width=500>		
<BR><BR>
		...
		<TR  height=30 >
			...
			<td colspan=3>
			 	<select name=outemp class=font9> 
			 		<option value="">全部</option>
			 		<option value="Y">已簽約</option>
			 		<option value="N">未簽約</option>
			 	</select>	
			</td>
		</TR>
		<TR  height=30 >
