...
sql="select * from wbphotos where aid='"& wbphotoid &"'"
...
<body  topmargin="40" leftmargin="10"  marginwidth="0" marginheight="0"  onkeydown="enterto()" onload="f()">
<form name="<%=self%>" method="post" action="<%=self%>.foregnd.asp">
<INPUT TYPE=HIDDEN NAME="UID" VALUE=<%=SESSION("NETUSER")%>>
<INPUT TYPE=hidden NAME=nowmonth VALUE="<%=nowmonth%>">
 
<TABLE  CLASS=txt BORDER=0 cellspacing="2" cellpadding="2" width=500>
	<Tr>
		<td  align=center valign=bottom  nowrap >
			<img src="wbphotos/<%=filename%>"  border=1 width=100 height=120  >
			<input name=filename value="<%=filename%>" type=hidden>
			<input name=wbphotoid value="<%=wbphotoid%>" type=hidden>
		</td>	 
		<TD width=100 align=right  valign=bottom>廠別<BR><font class=txt8>Xuong</font></TD>
		...
		<TD  valign=bottom   align=right width=100>類別<BR><font class=txt8>Loai</font></TD>
		<TD  valign=bottom >			
			<select name=wbloai  class=txt8  onchange='whsnochg()'  >
...
<TABLE WIDTH=520 CLASS=txt BORDER=0 cellspacing="2" cellpadding="2" >	 
	<TR height=35 > 
		...
		<TD  valign=top><INPUT NAME="EMPID" SIZE=12 CLASS=readonly maxlength=5 value="<%=wbid%>"></TD>	 
	...
	<tr height=35>
		...
		<td align=right >
		<a href="vbscript:getlorry()">
		<font color=blue>車號</font />
		</a>
		</td>
		<td valign=top>
...
<TABLE WIDTH=460>
		<tr ALIGN=center>
			<TD >
			<input type=button  name=send value="(Y)確認"  class=button onclick=go()>
