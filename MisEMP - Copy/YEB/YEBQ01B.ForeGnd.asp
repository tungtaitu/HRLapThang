...
sqlstr = sqlstr & "order by indat, empid  "
						...
						<td>
							<table class="txt" cellpadding=3 cellspacing=3> 
								<tr>
									...
									<td nowrap><input type="text" style="width:100px" name=inym value="<%=inym%>" ></td>
								...
								<TR height=25 > 
									...
									<TD colspan=3>
										<select name=GROUPID  class=txt8  onchange="datachg()" style="width:120">
											<option value=""></option>
										...
										<%SET RST=NOTHING %>
										<select name=zuno  class=txt8  onchange="datachg()" style="width:120">
											<option value=""></option>
									...
									<TD >
										<select name=shift  class=txt8  onchange="datachg()" style="width:120px">
								...
								<tr>
									...
									<td colspan=2><INPUT TYPE=BUTTON NAME=BTN VALUE="(S)查詢K.Tra" class="btn btn-sm btn-outline-secondary" onclick="datachg()" ONKEYDOWN="DATACHG()"></td>
								</TR>	
							</TABLE>
						</td>
					</tr>
						...
						<td align="center">
							<table id="myTableGrid" width="98%">
								<TR BGCOLOR="LightGrey" HEIGHT=25   >
									<TD width=50 nowrap align=center>photo</TD>
									...
									<TD width=70 nowrap align=center>簽合同日<BR>Ngay ky hop dong</TD>
									<TD width=70 nowrap align=center>離職日期<BR>NTX</TD>
									<TD width=70 nowrap align=center>護照號碼/發證日<BR>ngay cap</TD>
									<TD width=50 nowrap align=center>簽證號碼/發證地<BR>noi cap</TD>
									<TD width=60 nowrap align=center>職等<BR>Chuc vu</TD>
									<TD width=30 nowrap align=center>班別<BR>Loai Ca</TD>
									<TD width=75 nowrap align=center>單位部門<BR>Don Vi</TD>
									<TD width=50 nowrap align=center>廠別<BR>Loai Xuong</TD>
									<TD width=40 nowrap align=center>國籍<BR>Quoc tich</TD>
								</TR>
