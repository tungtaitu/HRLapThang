						...
						<td>
							<table  cellspacing="1" cellpadding="1" class="table table-bordered table-sm bg-white text-secondary" bgcolor=black>
								<tr bgcolor=#ffffff height=35>
									...
									<Td align=center bgcolor="#90ee90"  width=160 onMouseOver="this.style.backgroundColor='#FFEB78'" onMouseOut="this.style.backgroundColor='#90ee90'"   style="cursor:hand">外包資料維護<br>xoa/sua tu lieu thau ngoai</td>
						...
						<td>
							<table class="table-borderless table-sm bg-white text-secondary">
								...
								<tr>
									...
									<TD  valign=top><INPUT NAME="EMPID" SIZE=10 CLASS="form-control form-control-sm mb-2 mt-2"    maxlength=5 value="<%=empid%>" onblur="dchg(2)"></TD>
						...
						<td>
							<table class="table table-bordered table-sm bg-white text-secondary">
								<tr bgcolor=#e4e4e4 height=25>
									...
									<td align=center width=30>photo</td>
								...
								%>
									<TR BGCOLOR='<%=WKCOLOR%>' height=22 class=txt8 onMouseOver="this.style.backgroundColor='#FFEB78'" onMouseOut="this.style.backgroundColor='#ffffff'"   style="cursor:hand"  onclick="showdata(<%=currentrow-1%>)"  >
										...
										<Td align=center>
										<%if tmpRec(CurrentPage, CurrentRow, 25)<>"" then%>
											<img src="wbphotos/<%=tmpRec(CurrentPage, CurrentRow, 25)%>" width=30 height=30 border=0 >
										<%end if%>
										</td>
