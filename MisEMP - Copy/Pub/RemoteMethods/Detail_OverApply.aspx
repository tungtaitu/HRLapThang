<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Detail_OverApply.aspx.cs" Inherits="Pub_RemoteMethods_Detail_OverApply"  Theme="pwfBody"  Culture="auto"  UICulture="auto" %>
               ...
               <asp:TemplateField HeaderText="<%$ resources:Strings, LabsentDate %>">                                                   
                  ...
                  <nobr>
                      <asp:Label ID="lblStart_dateD" runat="server" Text='<%# Eval("sdate") %>'></asp:Label>~<asp:Label ID="lblEnd_dateD" runat="server" Text='<%# Eval("edate") %>'></asp:Label>
                       </nobr><br> ¡A<asp:Label ID="total" runat="server" Text="<%$ resources: Strings, total %>"></asp:Label>
                       <asp:Label ID="lblHr" runat="server" Text='<%# Eval("lhours") %>'></asp:Label>
                       <asp:Label ID="hr" runat="server" Text="<%$ resources: Strings, hr %>"></asp:Label>¡C
                   </ItemTemplate>
