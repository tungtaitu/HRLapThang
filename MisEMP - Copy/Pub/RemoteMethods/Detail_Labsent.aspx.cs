...
public partial class Pub_RemoteMethods_Detail_Labsent : System.Web.UI.Page
{
    PersonnelVN PL;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        switch (strEventName)
        {
            case "getLabsentDetail":
                string MID = GetMID(strEventName, Commfun.CheckParams("vou_no", Page));
                getLabsentDetail(MID);
                break;
        }
    }
    #region " 取得請假單明細 "
    private void getLabsentDetail(string MID)
    {
        PL = new PersonnelVN();
        ...
        try
        {
            DataTable dt = PL.Get_LabsentD_List(MID);
    ...
    private string GetMID(string strEventName, string vou_no)
    {
        ...
        switch (strEventName)
        {
            case "getLabsentDetail":
                ...
                DataTable dt = PL.SimpleGetData("labsentm", AL, "");
