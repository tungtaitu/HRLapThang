...
<table width=500  ><tr><td >
	<table width=400 align=center border=0 cellspacing="0" cellpadding="0"  >
		...
		<TR height=35 >
			...
			<td colspan=3>
				<input name=bhdat1 class=inputbox size=15 maxlength=10 onblur="date_change(3)"> ~
				<input name=bhdat2 class=inputbox size=15 maxlength=10 onblur="date_change(4)">
			</td>
		</TR>
		<TR height=35 >
			<td nowrap align=right >簽約統計：</td>
			<td colspan=3>
				<select  name=empTJ class=inputbox >
					<option value="">全部</option>
		...
		<TR  height=35 >
			...
			<TR  height=35 >
			<td nowrap align=right >排列方式：</td>
			<td colspan=3>
			 	<select name=orderby class=font9>
			 		<option value="empid">全部</option>
			 		<option value="groupid">依部門</option>
			 		<option value="empid">依工號</option>
			 	</select>
			</td>
		</TR>
	</table><BR>
