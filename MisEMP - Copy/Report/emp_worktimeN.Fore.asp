...
<table width=500  ><tr><td >
	<table width=400 align=center border=0 cellspacing="0" cellpadding="0"  > 
		<TR>
			<td nowrap align=right >統計日期：</td>
			<td colspan=3>
				<input name=D1 class=inputbox size=15 maxlength=10 onblur="date_change(1)">~
				<input name=D2 class=inputbox size=15 maxlength=10 onblur="date_change(2)">
			</td>
		</TR>
		<tr height=35 >
