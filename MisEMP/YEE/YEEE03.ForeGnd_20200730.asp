						...
						<td>
							<table id="myTableGrid" width="98%">
								<tr BGCOLOR="LightGrey" class="txt9">		
									...
									<%for k1=1 to tjnum %>	
										<TD align=center  nowrap ><%=left(tmprec(1,1,26+tjnum+k1),4)%><br>H</TD>
									<%next%>
									<TD align=center >調整</TD>
									<TD align=center  nowrap >年假<br>(天)</TD>
									<TD align=center  nowrap >年假<br>(時數)</TD>
									<TD align=center  nowrap >剩餘年假<br>(時數)<br>已修時數</TD> 
									<%if session("rights")<="2" then %>
										<TD align=center  nowrap >時薪<br>(6個月平均)</TD> 
										<TD align=center  nowrap >年假薪資</TD> 
									<%end if%>	
								...
								<TR BGCOLOR=<%=WKCOLOR%> class="txt9"> 	
									...
									<%for y = 1 to tjnum %>
											<TD align=center ><%if tmprec(1,x,26+y)<>"0" then %>
												<%=tmprec(1,x,26+y)%><%end if%>
											</td>
									<%next%> 		
									...
									<TD align=right nowrap="nowrap">
										<input type="text" class="readonly8" name="nowtx" value="<%=nowtxH%>" style="width:40px" readonly >
									...
									<%if session("rights")<="2" then %>
										...
										<input type="text" class="readonly8" name="njAmt" value="<%=nj_amt%>" style="width:40px"  readonly> 
										<%else%>
										<input type="text" class="readonly8" name="njAmt" value="0" style="width:40px"  >
										<%end if%>
										</td>
									<%else%>
