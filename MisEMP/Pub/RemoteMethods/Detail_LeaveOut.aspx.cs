...
public partial class Pub_RemoteMethods_Detail_LeaveOut : System.Web.UI.Page
{
    PersonnelVN PL;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        switch (strEventName)
        {
            case "getLeaveOutDetail":
                string MID = GetMID(strEventName, Commfun.CheckParams("vou_no", Page));
                getLeaveOutDetail(MID);
                break;
        }
    }
    #region " 取得請假單明細 "
    private void getLeaveOutDetail(string MID)
    {
        PL = new PersonnelVN();
        ...
        try
        {
            DataTable dt = PL.Get_LeaveOutD_List(MID);
    ...
    protected void getLeaveOutDetail_RowDataBound(object sender, GridViewRowEventArgs e)
    {
    ...
    private string GetMID(string strEventName, string vou_no)
    {
        ...
        switch (strEventName)
        {
            case "getLeaveOutDetail":
                ...
                DataTable dt = PL.SimpleGetData("lev_outm", AL, "");
