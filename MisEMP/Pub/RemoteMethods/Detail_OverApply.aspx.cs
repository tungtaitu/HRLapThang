...
public partial class Pub_RemoteMethods_Detail_OverApply : System.Web.UI.Page
{
    PersonnelVN PL;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        switch (strEventName)
        {
            case "getOverApplyDetail":
                string m_id = GetMID(strEventName, Commfun.CheckParams("vou_no", Page));
                getOverApplyDetail(m_id);
                break;
        }
    }
    ...
    private string GetMID(string strEventName, string vou_no)
    {
        ...
        switch (strEventName)
        {
            case "getOverApplyDetail":
                ...
                DataTable dt = PL.SimpleGetData("AppOvertimeM", AL, "");
    ...
    #region Bind Data
    private void getOverApplyDetail(string m_id)
    {
        PL = new PersonnelVN();
        ...
        try
        {
            DataTable dt = PL.Get_LabsentD_List(m_id);
            get_LabsentDetail.DataSource = dt;
            get_LabsentDetail.DataBind();
        }
        catch (Exception ex)
        {
        ...
        if (sbErrMsg.ToString().Trim() == "") //OK
        {
            ...
            hf.Controls.Add(get_LabsentDetail);
    ...
    protected void get_LabsentDetail_RowDataBound(object sender, GridViewRowEventArgs e)
    {
