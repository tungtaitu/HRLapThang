...
function showDetail_Over(objSender){
    ...
    if(jQuery.trim($(tdDetail).html())==""){
        ...
        getDetail_Over(tdDetail,vou_no);        
    }
...
function getDetail_Over(objSender,vou_no){
    var objServerVar;
	...
	$.ajax(
		{
			url:"../../Pub/RemoteMethods/Detail_Over.aspx",
			type:"post",
			data:"EventName=getDetail_Over&vou_no="+vou_no,
			dataType:"text",
			timeout:100000,
			error:function(err){
				objServerVar = {
