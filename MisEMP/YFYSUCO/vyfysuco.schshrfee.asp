...
function sch()
	<%=self%>.action="vyfysuco.schshrfee.asp?pgid=<%=request("pgid")%>"
	<%=self%>.submit()
end function
...
function REsch()
	...
	<%=self%>.salaryym.value=""
	<%=self%>.sgno.value=""
	<%=self%>.action="vyfysuco.schshrfee.asp"
	<%=self%>.submit()
end function
//-->
</SCRIPT>
...
<form name="<%=self%>" method="post" action="vyfysuco.schshrfeeshow.asp?pgid=<%=request("pgid")%>">
						...
						<td>
							<table class="txt" cellpadding=3 cellspacing=3>
								...
								<tr>
									...
									<td align=right >國籍 Quốc Tịch</td>
									<td >
									...
									<td nowrap>
										<input type=button name="send" value="查  詢" onclick="sch()" class="btn btn-sm btn-outline-secondary" >
										<input type=button name="send" value="重新查詢" onclick="REsch()" class="btn btn-sm btn-outline-secondary" >
									</td>
								</tr>
							</table>
						</td>
						...
						<td>
							<table width=750  CLASS=TXT8 BGCOLOR="#CCCCCC"  border="0"  cellspacing="1" cellpadding="1"    >
								<TR BGCOLOR="#FEF7CF"  >
									...
									<TD WIDTH=60 HEIGHT=20 ALIGN=CENTER NOWRAP>事故年月Ngày Sự Cố</TD>
									<TD WIDTH=60 ALIGN=CENTER NOWRAP>事故單號 Mã Sự Cố</TD>
									<TD WIDTH=80 ALIGN=CENTER NOWRAP>判定日期 Ngày</TD>
									<TD WIDTH=80 ALIGN=CENTER NOWRAP>事故金額 Tiền Sự Cố</TD>
									<TD WIDTH=50 ALIGN=CENTER NOWRAP>責任<br>單位 Đơn Vị Chịu Trách Nhiệm</TD>
									<TD WIDTH=80 ALIGN=CENTER NOWRAP>責任對象 Đối Tượng Chịu Trách Nhiệm</TD>
									<TD WIDTH=50 ALIGN=CENTER NOWRAP>幣別 Tiền Tệ</TD>
									<TD WIDTH=80 ALIGN=CENTER NOWRAP>事故扣款Trừ Tiền Sự Cố</TD>
									<TD WIDTH=60 ALIGN=CENTER NOWRAP>扣款年月Ngày Trừ Tiền</TD>									
								</TR>
							</table>
						</td>
					</tr>
					<tr>
						<td>
							<table height=500 width=780 CLASS=TXT8 BGCOLOR="#CCCCCC"  border="0"  cellspacing="0" cellpadding="0"  >
								<tr BGCOLOR="#ffffff" >
									<td valign=top>
									<iframe src="vyfysuco.schshrfeeshow.asp?salaryYM=<%=salaryYM%>&sgym=<%=SGYM%>&sgno=<%=sgno%>&groupid=<%=groupid%>&country=<%=country%>&cfgroup=<%=cfgroup%>" scrolling="auto" name=ce   width="100%" height="100%" marginheight=0 marginwidth=0 frameborder=0>
									</iframe>
									</td>
								</tr>
							</table>
