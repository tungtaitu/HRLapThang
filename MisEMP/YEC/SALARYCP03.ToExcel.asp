...
<TABLE CLASS="txt12" BORDER=1 cellspacing="1" cellpadding="1" >	
	<tr>
		<td colspan=20 align=center><font size=+1><b>CTY TNHH GIAY YUEN FOONG YU(VN)</b></font></td>
	</tr>
	<tr>
		<td colspan=20 align=center><font size=+1>基本薪資明細表</font></td>
	</tr>
	<tr>
		<td colspan=20 align=center><font size=+1><b>Thang &nbsp; <%=right(yymm,2)%> &nbsp; Nam &nbsp;  <%=left(yymm,4)%></b></font></td>
	</tr> 
	...
	<TR HEIGHT=25 BGCOLOR="#e4e4e4">
		...
		<td align=center>簽合同<br>Ngay K.H</td>
