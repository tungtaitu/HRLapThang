		...
		<td align="center">
			<table id="myTableForm" width="50%"> 
				...
				<tr height=30 >
					...
					<TD ><INPUT type="text" style="width:100px" NAME=YYMM   VALUE="<%=calcmonth%>">&nbsp;(YYYYMM)</TD>						 
				...
				<TR  height=30 >
					...
					<td nowrap align=right >排序方式<br>Sap xep</td>
					<td >
						<select name=sy type="text" style="width:120px">
							<option value="">全部</option>
							<option value="A">(Theo so the(依工號排序</option>
							<option value="B">(Theo NVX)依到職日期</option>
							<option value="C">(Theo Bo phan)依單位部門排序</option>
						</select>
					</td>
				</TR> 
				<TR  height=30 >
					<td align=right>
						<input type=checkbox name=func  onclick="funcchg()" > 
						<input type=hidden name=inbh value="">
					</td>
					<td colspan=3>
						印保險In BH
					</td>
