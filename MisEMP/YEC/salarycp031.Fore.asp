	...
	<tr>
		<td align="center">
			<table id="myTableForm" width="40%"> 
				...
				<tr >
					<TD nowrap align=right>年終年度：</TD>
					<TD ><INPUT type="text" style="width:100px" NAME=YYMM   VALUE="<%=left(calcmonth,4)%>"></TD>
					<TD nowrap align=right height=30 >國籍：</TD>
					<TD >
						<select name=country   style='width:120px'  >
							<%if Session("NETWHSNO")="ALL" or Session("RIGHTS")<="0"  then%>
				...
				<tr>		 
					...
					<TD > 
						<select name=WHSNO style="width:120px"  >
								<%if Session("RIGHTS")<="0" or Session("RIGHTS")="8" then%>
				...
				<tr >
					<td align=center colspan=4 height="50px">
						...
						<input type=button  name=btm class="btn btn-sm btn-outline-secondary" value="export EXCEL" onclick="goexcel()" style='background-color:#e4e4e4'>&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
			</table>
		</td>
