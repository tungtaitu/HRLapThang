		...
		<td align="center">
			<table id="myTableForm" width="50%"> 
				...
				<%if session("rights")<="1"  or session("rights")="5"   then  %>
					...
					<TD >
						<select name=acc   style='width:120px'  > 					 
				...
				<%else%>
					<td colspan=2><input type=hidden name=acc  value=""></td>
				<%end if%>	
				</tr>
				<TR>
				...
				<TR >
					...
					<td>
						<input type=checkbox name="func" onclick="funcchg()"> 績效獎金
