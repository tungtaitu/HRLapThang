	...
	<tr><td nowrap>
		<div id="navcontainer"  >
			...
			<%if session("rights")<="1" or session("netuser")="PELIN"  then %>
				<li  ><a href="vbscript:chgpage(6)">薪資資料<BR>Tien luong<BR>&nbsp;</a></li>
			<%else%>
...
<TABLE WIDTH=550 CLASS=txt BORDER=0  cellspacing="0" cellpadding="0">
	<TR height=25 >
		...
		<td width="110"  align=center valign=middle  nowrap  rowspan="6" ><img src="pic/<%=EMPID%>.jpg"  border=1 width=100 height=130> </td>
	</TR>
	<TR height=25 >
