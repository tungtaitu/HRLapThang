...
<TABLE WIDTH=600 CLASS=txt BORDER=0  cellspacing="0" cellpadding="0" ALIGN=CENTER>
	<TR>
		...
		<TD VALIGN=BOTTOM ALIGN=CENTER>
			...
			<font class=txtBK>海外幹部個人資料 dự liệu cán bộ hải ngoại</FONT>
			...
			<TABLE WIDTH=490 CLASS=TXT BORDER=0>
				<TR height=20>
					...
					<TD WIDTH=80 ALIGN=RIGHT>到職日期：</TD>
					<TD ><%=INDAT%></TD>
				</TR> 
				<TR height=20>
...
<TABLE WIDTH=600 CLASS="tabp" BORDER=0  cellspacing="0" cellpadding="4" ALIGN=CENTER> 
	<tr HEIGHT=30>
		<td width=90 align=right class="tdp" >姓名：</td>
		<td width=190 class="tdp"><%=empnam_cn%> <%=empnam_vn%></td>
		<td width=100 align=right class="tdp" >生日(西元)：</td>             
		<td class="tdp"><%=bdy%></td>
	</tr> 
	<tr  HEIGHT=30>
		<td  align=right class="tdp" >姓別：</td>
		<td class="tdp" >
			<%if sex="M" then%><img src="../picture/y01.gif" align="absmiddle" width=12 height=12>&nbsp;男 <%else%><img src="../picture/n01.gif" align="absmiddle" width=12 height=12>&nbsp;男<%end if %>&nbsp;		
			<%if sex="F" then%><img src="../picture/y01.gif" align="absmiddle" width=12 height=12>&nbsp;女 <%else%><img src="../picture/n01.gif" align="absmiddle" width=12 height=12>&nbsp;女<%end if %>&nbsp;		
		</td>
		<td  align=right class="tdp" >婚姻狀況：</td>             
		<td class="tdp" >
			<%if marryed="Y" then%><img src="../picture/y01.gif" align="absmiddle" width=12 height=12>&nbsp;已婚<%else%><img src="../picture/n01.gif" align="absmiddle" width=12 height=12>&nbsp;已婚<%end if%>&nbsp;
			<%if marryed="N" then%><img src="../picture/y01.gif" align="absmiddle" width=12 height=12>&nbsp;未婚<%else%><img src="../picture/n01.gif" align="absmiddle" width=12 height=12>&nbsp;未婚<%end if%>&nbsp;
			<%if (marryed<>"N" and marryed<>"Y" ) then%><img src="../picture/y01.gif" align="absmiddle" width=12 height=12>&nbsp;其他<%else%><img src="../picture/n01.gif" align="absmiddle" width=12 height=12>&nbsp;其他<%end if%>&nbsp;
			
		</td>
	</tr>		
	<tr  HEIGHT=30>
		<td   align=right class="tdp">身分證號：</td>
		<td   class="tdp"><%=personid%>&nbsp</td>
		<td  align=right class="tdp">護照號碼：</td>             
		<td class="tdp"><%=passportNo%>&nbsp</td>
	</tr>	
	<tr  HEIGHT=30>
		<td  align=right class="tdp">護照簽發日：</td>
		<td  class="tdp"><%=pissuedate%>&nbsp</td>
		<td  align=right class="tdp">護照到期日：</td>             
		<td class="tdp"><%=pduedate%>&nbsp</td>
	</tr>		
	<tr  HEIGHT=30>
		<td  align=right class="tdp">工作證號：</td>
		<td   class="tdp"><%=wkd_no%>&nbsp;</td>
		<td  align=right class="tdp">工作證到期日：</td>             
		<td class="tdp"><%=wkd_duedate%>&nbsp;</td>
	</tr>	
	<tr  HEIGHT=30>
		<td  align=right class="tdp">教育程度：</td>
		<td   class="tdp"><%=school%>&nbsp;</td>
		<td  align=right class="tdp">E-Mail：</td>             
		<td class="tdp"><%=EMAIL%>&nbsp;</td>
	</tr>			
	<tr  HEIGHT=30>
		<td  class="tdp" colspan=4 bgcolor=#e4e4e4>&nbsp;----- <b>＊廠內聯絡資訊</b> -------------------------------------------------------------------------------</td>
	</tr>	
	<tr  HEIGHT=30>
		<td  align=right class="tdp">聯繫電話：</td>
		<td   class="tdp"><%=phone%>&nbsp;</td>
		<td  align=right class="tdp">手機：</td>             
		<td class="tdp"><%=mobilephone%>&nbsp;</td>
	</tr>		
	<tr  HEIGHT=30>
		<td  align=right class="tdp">銀行帳號：</td>
		<td   class="tdp" colspan=3>&nbsp;</td>		
	</tr>	
	<tr  HEIGHT=30>
		<td  class="tdp" colspan=4 bgcolor=#e4e4e4>&nbsp;----- <b>＊國內聯絡資訊</b> -------------------------------------------------------------------------------</td>
	</tr>	 
	<tr  HEIGHT=30>
		<td  align=right class="tdp">緊急聯繫電話：</td>
		<td   class="tdp"><%=urgent_tel%>&nbsp;</td>
		<td  align=right class="tdp">手機：</td>             
		<td class="tdp"><%=urgent_mobile%>&nbsp;</td>
	</tr>		
	<tr  HEIGHT=30>
		<td  align=right class="tdp">緊急連絡人：</td>
		<td   class="tdp"><%=urgent_person%>&nbsp;</td>
		<td  align=right class="tdp">關係：</td>             
		<td class="tdp"><%=releation%>&nbsp;</td>		
	</tr>	
	<tr  HEIGHT=30>	
		<td  align=right class="tdp">聯絡地址：</td>
		<td   class="tdp" colspan=3><%=urgent_addr%>&nbsp;</td>		
	</tr>
	<tr  HEIGHT=30>
		<td  align=right class="tdp">保險受益人：</td>
		<td   class="tdp"><%=bh_person%>&nbsp;</td>
		<td  align=right class="tdp">受益人身分証號：</td>             
		<td class="tdp"><%=bh_personID%>&nbsp;</td>		
	</tr>	
	<tr  HEIGHT=30>
		<td  align=right class="tdp" valign=top>經歷：<br><br><br></td>
		<td   class="tdp" colspan=3 valign=top><%=experience%>&nbsp;</td>		
	</tr>	
	<tr HEIGHT=30>
		<td  align=right class="tdp" valign=top>備註說明：<br><br><br><br><br><br></td>
