...
<table width=500  ><tr><td >
	<table width=400 align=center border=0 cellspacing="0" cellpadding="0"  > 		 
			...
			<td nowrap align=right >員工編號<font class=txt>So The</font>：</td>
			<td colspan=3>
				<input name=empid1 class=inputbox size=12 maxlength=5 onchange=strchg(1)> 
				
			</td>
		</TR>
		<TR  height=30 >
			<td nowrap align=right >到職日<font class=txt>NVX</font>：</td>
			<td colspan=3>
				<input name=indat1 class=inputbox size=12 maxlength=5 onblur=date_change(1)> 
		...
		<tr>		 
			<TD nowrap align=right height=30 >廠別<font class=txt>Loai Xuong</font>：</TD>
			<TD > 
		...
		<tr>	 
		<TR height=30 >
			<TD nowrap align=right >組/部門<font class=txt>Loai Bo phan</font>：</TD>
			<TD >
		...
		<TR  height=30 >
			...
			<td colspan=3>
			 	<select name=outemp class=font9> 
			 		...
			 		<option value="Y">已簽約(Y-Co hop thong)</option>
			 		<option value="N">未簽約(N-Ko hop thong)</option>
			 	</select>	
			</td>
		</TR>
			...
			<td colspan=3>
			 	<select name=IOemp class=font9> 
			 		<option value="Y">在職</option>
			 		<option value="">全部</option>
			 		<option value="N">已離職</option>
			 	</select>	
			</td>
		</TR>
	</table><BR>	
