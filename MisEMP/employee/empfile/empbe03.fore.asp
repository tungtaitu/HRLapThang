...
<table width="460" border="0" cellspacing="0" cellpadding="0">
	...
	<tr height=40 >
		<td width=150 align=center valign=middle>
			<font color="Brown"><b>簽證資料新增</b></font>
		</td>
		<td width=180 align=center>
			<img border="0" src="../../picture/icon02.gif" align="absmiddle"> 
			<a href="empbe0301.asp" target="_parent">簽證資料異動查詢</a>
		</td>
		<td></td>
	</tr>
</table>
...
<table width=500  ><tr><td >
	<table width=450 class=txt9>
		...
		<tr>
			...
			<td>
				<input name=visano size=10 class=inputbox  onblur="visanochg(<%=i-1%>)" maxlength=8>
			</td>	
			<td>
			...
			<td>
				<input name=visaAmt size=10 class=inputbox onblur="amtchg(<%=i-1%>)" value="0" style='text-align:right'>
			</td>	
			<td>
				<input name=memo size=15 class=inputbox onblur="visanochg(<%=i-1%>)" >
			</td>	
		</tr>
		<%next%>
	</table>	
