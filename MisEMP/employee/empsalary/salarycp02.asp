...
<table width=500  ><tr><td >
	<table width=400 align=center border=0 cellspacing="0" cellpadding="0"  > 
		<tr height=30 >
			<TD nowrap align=right>0.計薪年月：</TD>
			<TD ><INPUT NAME=YYMM  CLASS=INPUTBOX VALUE="<%=calcmonth%>" SIZE=10></TD>	
		</TR>
		<TR>
		 	<TD nowrap align=right height=30 >1.國籍：</TD>
			<TD >
		...
		<tr>		 
			<TD nowrap align=right height=30 >2.廠別：</TD>
			<TD > 
		...
		<tr>	 
		<TR height=30 >
			<TD nowrap align=right >3.組/部門：</TD>
			<TD >
		...
		<TR  height=35 >
			...
			<td colspan=3>
			 	<input type=checkbox name="func" onclick="funcchg()"> 不印績效獎金
			 	<input size=1 name=nojx type=hidden value="">
			</td>
		</TR>	
		<TR  height=35 > 
	...
	<table width=450 align=center>
		<tr >
			<td align=center>
				<input type=button  name=btm class=button value="(Y)確認Print" onclick="go()" onkeydown="go()">
