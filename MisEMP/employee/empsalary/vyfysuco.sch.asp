...
<table height=250 width=780 CLASS=TXT8 BGCOLOR="#CCCCCC"  border="0"  cellspacing="0" cellpadding="0"  >
	<tr BGCOLOR="#ffffff" >
		<td valign=top>
		<iframe src="vyfysuco.schtest.asp?salaryYM=<%=salaryYM%>&sgym=<%=SGYM%>&groupid=<%=groupid%>&country=<%=country%>&cfgroup=<%=cfgroup%>" scrolling="auto" name=ce   width=100% height=100% marginheight=0 marginwidth=0 frameborder=0>
		</iframe>
		</td>
	</tr>
</table>
