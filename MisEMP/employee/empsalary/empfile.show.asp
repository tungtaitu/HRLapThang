...
<TABLE WIDTH=510 CLASS=FONT9 BORDER=0> 
	<TR height=25 > 
		...
		<td width="130" rowspan="5" align=center valign=center>
				<img src="../../yeb/pic/<%=empid%>.jpg" width="100" height="120" border=1>
			</td>
	</TR>
	<TR height=25 >
...
<TABLE WIDTH=500 CLASS=FONT9 BORDER=0> 
	...
	<tr>
		...
		<td colspan=3>
			<textarea rows="3" name="studyjob" cols="40" class=readonly readonly ><%=studyjob%></textarea>
