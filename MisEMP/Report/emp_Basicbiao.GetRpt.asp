<%
const self ="emp_baiscbaio.getrpt.asp"
%>
<% 

if request("orderby")="groupid" then 
	reportname = "emp_Basicbiao.rpt"
else	
	reportname = "emp_Basicbiao_byempid.rpt"
end if 	
...
Session("oRpt").ParameterFields(9).AddCurrentValue(Cstr(code09))
Session("oRpt").ParameterFields(10).AddCurrentValue(Cstr(code10))
Session("oRpt").ParameterFields(11).AddCurrentValue(Cstr(code11))
Session("oRpt").ParameterFields(12).AddCurrentValue(Cstr(code12))
