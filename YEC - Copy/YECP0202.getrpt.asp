<%
const self ="yecp0302.getrpt.asp"
%>
<% 
...
'Session("oRpt").ParameterFields(7).AddCurrentValue(Cstr(outemp))
'Session("oRpt").ParameterFields(8).AddCurrentValue(Cstr(acc))
