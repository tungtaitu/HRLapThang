	...
	<tr>
		<td align="center">
			<table id="myTableForm" width="40%"> 
				...
				<tr height=30 >
					<TD nowrap align=right>統計年月<br>yyyymm</TD>
					<TD >
						<INPUT type="text" style="width:100px" NAME=YM1  VALUE="<%=calcmonth%>">
						<INPUT type='hidden' NAME=YM2   VALUE="<%=calcmonth%>" SIZE=10> 
					</TD>
					<TD nowrap align=right>工號<br>so the</TD>
					<TD >
						<INPUT style="width:100px" NAME=empid1 VALUE="" >  
					</TD>	
				</TR>
				<tr >
